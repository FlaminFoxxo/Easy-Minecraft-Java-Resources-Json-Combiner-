Hello! I made this script to combine the item Json files in Minecraft Java resource packs, the windows one I would recommend running in vs-code and for android you can run it in the below app:
